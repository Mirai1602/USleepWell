...
Autor: Mayrin Tellez
Fecha: 2025-06-26
Descripción: Este es el archivo para el registro del usuario. Aquí se definen las funciones
"""
...
def GuardarDatos(nombre, apellido, Nacimiento, email, id, Archivo='DatosUsuarios.csv'):
    ...
    with open(Archivo, 'a', newline= '' ,encoding='utf-8') as file:
        ...
        # 'utf-8' es una codificación común que maneja caracteres especiales, quiero evitar que la ñ no sirva
    ...
    ValidarDatos(nombre, apellido, Nacimiento, email) #Llama a la funcion de validar datos
